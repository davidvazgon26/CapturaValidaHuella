...
namespace ZK9500.Fingerprint.Service.Helpers
{
    public static class BitmapHelper
    {
        ...
        /*******************************************
         * Nombre de la función: RotatePic
         * Función de la función: Rotar la imagen, el propósito es asegurar que la imagen guardada y mostrada no sea diferente de la dirección de la huella dactilar presionada.
         * Parámetro de entrada de la función: BmpBuf---Cadena de caracteres de la huella dactilar antes de la rotación
         * Parámetro de salida de la función: ResBuf---Cadena de caracteres de la huella dactilar después de la rotación
        ...
        /*******************************************
          * Nombre de la función: StructToBytes
          * Función de la función: Convertir la estructura en un array de bytes sin signo
          * Parámetro de entrada de la función: StructObj---La estructura a convertir
          * Size---El tamaño de la estructura a convertir
          * Parámetro de salida de la función: Ninguno
          * Valor de retorno de la función: El array después de la conversión de la estructura
          ********************************************/
        ...
        /*******************************************
          * Nombre de la función: GetBitmap
          * Función de la función: Guardar los datos pasados como una imagen
          * Parámetro de entrada de la función: buffer---Datos de la imagen
          * nWidth---Ancho de la imagen
          * nHeight---Alto de la imagen
          * Parámetro de salida de la función: Ninguno
          * Valor de retorno de la función: Ninguno
          ********************************************/
        public static void GetBitmap(byte[] buffer, int nWidth, int nHeight, ref MemoryStream ms)
        {
            ...
            try
            {
                ...
                // Información del encabezado de la imagen
                ...
                // Información del encabezado del archivo
                ...
                // Rotación de la imagen, resuelve el problema de la imagen de la huella dactilar invertida
        ...
        /*******************************************
         * Nombre de la función: WriteBitmap
         * Función de la función: Guardar los datos pasados como una imagen
         * Parámetro de entrada de la función: buffer---Datos de la imagen
         * nWidth---Ancho de la imagen
         * nHeight---Alto de la imagen
